...
--------------------------------------------------
➣ Auther   : MARWAT
➣ GitHub   : https://github.com/marwattricks398
➣ YouTube  : MARWAT TRICKS
➣ Blogspot : https://www.facebook.com/profile.php?id=100042965112748
--------------------------------------------------
                                """
...
def token():
	...
	try:
		...
		zedd.write(toket)
		zedd.close()
		print '\033[0;92m√ Login Successfull'
		menu()
	except KeyError:
...
def action():
	...
	if chb =="":
	    ...
	    psb("✓")
	    psb("✓")
	    psb("Congratulations MARWAT Tool Has Been Updated Successfully")
	    time.sleep(2)
	    menu()
	elif chb =="7":
